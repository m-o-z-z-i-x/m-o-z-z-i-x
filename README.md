...
<div>
  <p>I'm a <strong>Full-Stack Developer</strong> with over 4 years of experience building large-scale B2B solutions and enterprise systems — from architecture and business logic to clean, responsive interfaces. I care deeply about code quality, usability, and scalability</p>
  <p>
    <strong>Frontend:</strong> Modern, user-friendly interfaces with <strong>Vue.js, JavaScript (ES6+) / TypeScript, HTML5, CSS3</strong> and related tooling<br>
    <br>
    <strong>Backend:</strong> Reliable APIs and complex business logic in <strong>PHP</strong> and <strong>Python</strong> — with strong hands-on experience in <strong>FastAPI, SQLAlchemy, Pydantic, Alembic, and Celery</strong> — backed by scalable <strong>MySQL/PostgreSQL</strong> database design<br>
    <br>
    <strong>Desktop:</strong> Cross-platform GUI tools and internal utilities built with <strong>Python + PyQt</strong>
  </p>
  <p>Beyond core development, I'm comfortable with DevOps and infrastructure: I set up and maintain Linux and Windows servers, automate workflows with Bash and PowerShell, and keep both development and production environments stable and secure</p>
  <p><i>While information security isn't my primary focus, I treat it as an essential part of reliable engineering and apply it in practice</i></p>
...
<div>
  <img src="https://github-stats-extended.vercel.app/api?username=m-o-z-z-i-x&show_icons=true&theme=graywhite&include_all_commits=true&count_private=true" alt="GitHub Stats" width="49%">
  <img src="https://roadmap.sh/card/wide/67e4a807616abc6b0b6a41ad?variant=light&roadmaps=frontend%2Cvue%2Cjavascript%2Cpython" alt="roadmap.sh" width="49%">
</div>
